...
class Sam3VideoPredictorMultiGPU(Sam3VideoPredictor):
    def __init__(self, *model_args, gpus_to_use=None, **model_kwargs):
        if gpus_to_use is None:
            # AANGEPAST VOOR CPU: Check of er een GPU is, anders lege lijst
        ...
        if IS_MAIN_PROCESS:
            ...
            # AANGEPAST VOOR CPU: Assertions alleen doen als er GPUs zijn
        ...
        # AANGEPAST VOOR CPU: Device instelling
